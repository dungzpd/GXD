                        ...
                        <form action="{!! URL::action('\Backend\Controllers\AuthController@login') !!}" method="post">
                            ...
                            <div class="form-group no-margin-top">                                    
                                <div class="col-sm-12">
                                    <div class="row pass-area">                                        
                                        ...
                                        <a class="btn btn-link forgot-link" href="{!! URL::action('\Backend\Controllers\AuthController@forgot') !!}">Quên?</a>                                    
                                    </div>                                                                                                            
                                </div>
                            </div>
                            ...
                            <div class="form-group margin-top-45">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row overflow-hidden">
                                        <a href="{!! URL::action('\Backend\Controllers\AuthController@register') !!}">
...
<!--@extends('Backend::layouts.frontend.main')
