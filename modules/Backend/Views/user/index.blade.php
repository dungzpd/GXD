...
@section('title', Lang::get('user.accountList'))
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <form action="{!! URL::action('\Backend\Controllers\UserController@index') !!}" method="post">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls series-action-top">
                        ...
                        <button type="button" class="btn btn-danger btn-sm" data-link="{!! URL::action('\Backend\Controllers\UserController@deleteMultiple') !!}"><i class="fa fa-trash"></i></button>                        
                        ...
                        <div class="row-group header-list">
                            <div class="row item">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        @lang('user.username')                                         
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\UserController@index', 'field' => 'username', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>                                    
                                    <div class="col-md-3">
                                        @lang('user.email')
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\UserController@index', 'field' => 'email', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>
                                    <div class="col-md-2">
                                        @lang('user.role')
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\UserController@index', 'field' => 'role', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>
                                    <div class="col-md-2">
                                        @lang('user.status') 
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\UserController@index', 'field' => 'status', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>    
                                    <div class="col-md-2">
                                        @lang('user.actions')
                                    </div> 
                                ...
                                @foreach($users as $user)
                                    <div class="row item">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{!! URL::action('\Backend\Controllers\UserController@edit', array('id' => $user->id))!!}">
                                                    {!! $user->username !!}                               
                                                </a>
                                            </div>                                            
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-2">                                                       
                                                <a href="{!! URL::action('\Backend\Controllers\UserController@status', array('id' => $user->id)) !!}">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a href="{!! URL::action('\Backend\Controllers\UserController@delete', array('id' => $user->id, 'currentPage' => $users->currentPage())) !!}">
