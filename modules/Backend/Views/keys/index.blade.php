        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('courses.courses')</h3>
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-controls series-action-top">
                        ...
                        <button type="button"
                                ...
                                data-link="{!! URL::action('\Backend\Controllers\CourseController@deleteMultiple') !!}">
                        ...
                        <div class="row-group header-list">
                            <div class="row item">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-1">
                                        @lang('courses.mkh')
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\CourseController@index', 'field' => 'id', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>
                                    <div class="col-md-4">
                                        @lang('courses.name')                                         
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\CourseController@index', 'field' => 'name', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>                                    
                                    <div class="col-md-2">
                                        @lang('courses.price')
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\CourseController@index', 'field' => 'price', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>
                                    <div class="col-md-2">
                                        @lang('courses.duration')
                                        {!! \Alloy\Facades\MainFacade::generateSort(['link' => '\Backend\Controllers\CourseController@index', 'field' => 'duration', 'sort' => $sort, 'field_vs' => $field]) !!}
                                    </div>
                                    <div class="col-md-2">
                            ...
                            @if(!empty($list)) 
                                ...
                                <div class="row item">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            <a href="{!! URL::action('\Backend\Controllers\CourseController@status', array('id' => $item->id, 'currentPage' => $list->currentPage())) !!}">
                                                <button type="button"
                                                        init="tooltip"
                                            ...
                                            <a href="{!! URL::action('\Backend\Controllers\CourseController@delete', array('id' => $item->id, 'currentPage' => $list->currentPage())) !!}">
                                                <button type="button"
                                                        init="tooltip"
