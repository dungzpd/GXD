...
class ProductController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Backend::products.index', compact('list', 'sort', 'keyword', 'field', 'category', 'categories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $form = array(
            'isEdit' => false,
            'title' => Lang::get('products.add'),
            'action' => URL::action('\Backend\Controllers\ProductController@create')
        ...
        return view('Backend::products.form', compact('form', 'products', 'categories', 'sections', 'messages'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        $form = array(
            ...
            'action' => URL::action('\Backend\Controllers\ProductController@edit', array('id' => $identify->id))
        );
